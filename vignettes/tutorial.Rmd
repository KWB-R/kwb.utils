...
This function adds a suffix to all elements of a vector of character. It is thus
just a shortcut to `paste0(values, suffix)` but allows to define values to be
omitted:
...
that it is free or at least almost free of duplication. I have to admit that
this is a very hard goal to achieve! But we should try our best!
